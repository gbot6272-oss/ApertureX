...
import { DotLoader, RING_SPINNER_FRAMES } from "./ui/DotLoader";
...
export function GlobalBusyIndicator() {
  ...
  return (
    ...
    >
      <DotLoader frames={RING_SPINNER_FRAMES} duration={90} dotClassName="bg-text-muted/25 [&.active]:bg-accent size-1" />
