...
//! Modellinferenz ist in dieser Umgebung nicht seriös umsetzbar — kein
//! legitimer Weg, echte Segmentierungs-Modellgewichte zu beschaffen und
//! mitzuliefern. Die fünf KI-Masken (`segmentation`-Modul) sind deshalb
//! echte, deterministische, klassische Bildverarbeitungsheuristiken statt
//! echter tiefer neuronaler Netze — jede eine genuine, unit-getestete
//! Fähigkeit, kein Platzhalter. Der Preset-Generator (`preset_generator`-
//! Modul) nutzt dagegen einen echten Anthropic-Messages-API-Client für
//! seinen LLM-Modus.
//!
//! Modulübersicht:
